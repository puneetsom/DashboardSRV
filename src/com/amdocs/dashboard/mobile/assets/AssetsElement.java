...
/**
 * Assets are retrieved from server through Mobile Proxy after the user logs in.
 * 
 * <p>Java class for AssetsElement complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AssetsElement">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="Asset" type="{http://www.amdocs.com/dashboard/mobile}AssetElement" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AssetsElement", propOrder = {
    "assets"
})
public class AssetsElement {

    @XmlElement(name = "Asset", required = true)
    protected List<AssetElement> assets;
    ...
    public List<AssetElement> getAssets() {
        if (assets == null) {
            assets = new ArrayList<AssetElement>();
        }
        return this.assets;
    }
