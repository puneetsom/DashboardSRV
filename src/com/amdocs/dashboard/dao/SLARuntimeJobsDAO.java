...
public class SLARuntimeJobsDAO implements SQLConstants {
...
private static Logger logger = Logger.getLogger("com.amdocs.dashboard.dao");
	...
	public int update(Map<Object, Object> parms) throws SQLException
	{
        ...
        try
		{
            ...
            logger.info("SLARuntimeJobsDAO.updateAdjustIndicator: " + updated + " row(s) updated (" + queryMap.get(SQL_QUERY) + ")");
		}
		catch(SQLException e)
		{
			logger.severe("SLARuntimeJobsDAO.updateAdjustIndicator: Error updating! (" + queryMap.get(SQL_QUERY) + ")");
			e.printStackTrace();
			throw e;
		}catch(Exception e)
		{
